...
webapp.controller('WerknemerController', ['$scope', 'WerknemerService', function($scope, WerknemerService) {
          var self = this;
          //self.werknemer= new WerknemerService();
           
          self.werknemers=[];
               
          self.getAllWerknemers = function(){
              self.werknemers = WerknemerService.query();
          };
